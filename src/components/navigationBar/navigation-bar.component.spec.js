...
describe('NavigationBarComponent', () => {
  ...
  beforeEach(() => {
    ...
    initOnNavigationItemClickedHandlerSpy = spyOn(
      NavigationBarComponent.prototype,
  ...
  test('should setActiveLink correctly', () => {
    document.body.innerHTML =
      '<div>' + '  <a href="#in-theaters" class="menu-link">Now in Theaters</a>' + '</div>';
  ...
  test('should initOnNavigationItemClickedHandler correctly', () => {
    ...
    navigationBarComponent.navigationBarContainer.innerHTML =
      '  <a href="#in-theaters" class="menu-link active-header-link">Now in Theaters</a>' +
    ...
    navigationBarComponent.navigationBarContainer
      .querySelector('[href="#search-movies"]')
      .dispatchEvent(new Event('mouseup', {bubbles: true, cancelable: false}));
    expect(
      navigationBarComponent.navigationBarContainer
        .querySelector('[href="#in-theaters"]')
        .classList.contains('active-header-link'),
    ).toBeFalsy();
    expect(
      navigationBarComponent.navigationBarContainer
        .querySelector('[href="#search-movies"]')
